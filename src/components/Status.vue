<template>
  <div>
    <div class="logo-width" style="margin: auto;">
      ...
      <div class="row" style="display: flex" v-if="!errorMsg">
        ...
        <div class="col-xs-3" v-for="tier in tiers" v-bind:key="tier.name" >
          ...
          <div v-bind:class="{ currentTier: tier.isCurrent }"  style="display: flex; flex-direction: column; align-items: center; padding: 12px">
            ...
            <div class="row blue">
              <div v-if="tier.amount === tier.maxAmount || tier.type === 'INCOMING'">
...
<style>
  ...
  .activeTier{
    background: linear-gradient(90deg,#0294ff,#4cf369);
  }
  ...
  .incomingTier{
    background: linear-gradient(90deg,#2273f3,#764cf3);
  }
</style>
