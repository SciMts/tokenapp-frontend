...
//       ivsize: 16
//     })
//     var decipher = ethUtil.crypto.createDecipheriv('aes-256-cbc', evp.key,
//       evp.iv)
...
//   var derivedKey = ethUtil.crypto.pbkdf2Sync(Buffer(password), Buffer(password),
//     2000, 32, 'sha256').slice(0, 16)
//   var decipher = ethUtil.crypto.createDecipheriv('aes-128-cbc', derivedKey,
//     encseed.slice(0, 16))
...
//   var json = (typeof input === 'object') ? input : JSON.parse(
...
//     derivedKey = ethUtil.scrypt(new Buffer(password),
//       new Buffer(kdfparams.salt, 'hex'), kdfparams.n, kdfparams.r, kdfparams.p,
//       kdfparams.dklen)
...
//     }
//     derivedKey = ethUtil.crypto.pbkdf2Sync(new Buffer(password),
...
//   }
//   var decipher = ethUtil.crypto.createDecipheriv(json.crypto.cipher,
//     derivedKey.slice(0, 16), new Buffer(json.crypto.cipherparams.iv, 'hex'))
...
//     this.getAddress().toString('hex')].join('')
// }
